...
public class ServerApplication {
	...
	public static void main(String[] args) {
		...
		final int serverPort=50007;
		
		try {
			
			// Instantiate a new DatagramSocket to receive responses from the client
		    DatagramSocket serverSocket = new DatagramSocket(50007);
            ...
            char ch[]= new char[receivedData.length()];     
            for(int i=0;i<receivedData.length();i++)  
            {  
                ch[i]= receivedData.charAt(i);  
            ...
            String Var=Integer.toString(count);
		    System.out.print("Sent to Client-Total number of Computer Words:"+Var);
		    // Process data - convert to upper case
		   String sendingData = Var.toUpperCase();
	...
	private static String valueOf(int count) {
